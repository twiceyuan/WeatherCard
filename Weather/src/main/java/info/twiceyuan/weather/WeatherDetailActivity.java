 ...
 */
public class WeatherDetailActivity extends Activity implements Runnable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cityView = (TextView) findViewById(R.id.city_title);
        cardLayout = (LinearLayout) findViewById(R.id.detail_layout);
    ...
    public void run() {
        ...
        card_container = new NowLayout(this);
    ...
    LinearLayout getCard() {
        LinearLayout card = (LinearLayout) LinearLayout.inflate(this, R.layout.weather_detail_card, null);
